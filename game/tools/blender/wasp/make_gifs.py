...
# renders/wasp_<clip>.gif (512x640, matches build_wasp.py's anim frame render
...
FPS = 24
FRAME_STEP = 2  # build_wasp.py renders every 2nd frame
...
for clip in CLIPS:
    ...
    out_path = os.path.join(REN_DIR, f"wasp_{clip}.gif")
    frames[0].save(
        out_path,
        save_all=True,
