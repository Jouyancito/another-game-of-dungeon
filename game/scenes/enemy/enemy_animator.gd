...
const CLIP_DP_MOVE   := "hop"      # slimes hop; other species name theirs the same
...
func _init(model_root: Node) -> void:
	...
	_is_dp_type     = CLIP_DP_IDLE in clips and CLIP_DP_MOVE in clips
